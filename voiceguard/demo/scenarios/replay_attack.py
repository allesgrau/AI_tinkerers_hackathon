...
scenario = [
    ...
    {"delay": 3.0, "type": "transcript.add", "speaker": "user", "text": "The code is 583920."},
    ...
    {"delay": 0.5, "type": "transcript.add", "speaker": "agent", "text": "I’m sorry, we detected an irregularity in the voice verification. The session has been rejected. Please contact the clinic in person."},
]
